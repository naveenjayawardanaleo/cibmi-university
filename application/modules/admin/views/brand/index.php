                                        ...
                                        <tbody>
                                            <?php foreach ($records as $k => $row) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="<?= base_url() ?>Edit-Brand/<?= $row->BrandId ?>" class="btn btn-warning btn-sm mr-2">
                                                            Edit
                                                        </a>
                                                        <button type="button" onclick="delete_modal('<?= base_url() ?>Delete-Brand/<?= $row->BrandId ?>');" class="btn btn-danger btn-sm mr-2"><i class="fas fa-ban"></i>Delete</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
