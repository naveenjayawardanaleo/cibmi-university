                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Quartz/form/<?= $obj->QuartzId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="QuartzTitle">Quartz Title</label>
                                            <input type="text" value="<?= $obj->QuartzTitle ?>" name="form[QuartzTitle]" class="form-control" id="QuartzTitle" required>
                                        </div>
                                        <div class="form-group">
