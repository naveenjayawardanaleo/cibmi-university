...
<div class="contact-area pt-120 pb-90">
    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="contact-select">
                                <select class="mb-20" required>
                                    <option value="Subject">Gender</option>
                        ...
                        <div class="col-xl-6">
                            <div class="contact-select">
                                <select class="mb-20" required>
                                    <option value="Subject">Select Programe</option>
                                    <option value="Subject">Business Management </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="contact-from-input mb-20">
                                ...
                                <textarea placeholder="Message" name="message" style="height: 120px;" required></textarea>
                        ...
                        <div class="support-contact-inner">
                            ...
                            <div class="support-item">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.57" height="16.271" viewBox="0 0 22.57 16.271">
                                        <g id="email_3_" data-name="email (3)" transform="translate(-1.25 -4.25)">
                                            <path id="Path_10" data-name="Path 10" d="M20.933,20.521H4.137A2.9,2.9,0,0,1,1.25,17.634V7.137A2.9,2.9,0,0,1,4.137,4.25h16.8A2.9,2.9,0,0,1,23.82,7.137v10.5A2.9,2.9,0,0,1,20.933,20.521Zm-16.8-14.7A1.312,1.312,0,0,0,2.825,7.137v10.5a1.312,1.312,0,0,0,1.312,1.312h16.8a1.312,1.312,0,0,0,1.312-1.312V7.137a1.312,1.312,0,0,0-1.312-1.312Z" transform="translate(0 0)" fill="#2467ec"></path>
                                            <path id="Path_11" data-name="Path 11" d="M12.534,13.7a3.412,3.412,0,0,1-1.732-.472L1.638,7.778a.8.8,0,0,1-.283-1.05A.777.777,0,0,1,2.4,6.455l9.175,5.438a1.774,1.774,0,0,0,1.848,0L22.6,6.455a.777.777,0,0,1,1.05.273.8.8,0,0,1-.283,1.05l-9.1,5.448a3.412,3.412,0,0,1-1.732.472Z" transform="translate(0.001 0.105)" fill="#2467ec"></path>
                                        </g>
                                    </svg>
                                ...
                                <div class="support-info-email">
                                    <span>Email</span>
                                    <a href="mailto:info@cibmi.lk">info@cibmi.lk</a>
                                </div>
                            </div>
                            <div class="support-item">
                                <div class="support-icon">
            ...
            <div class="col-md-12">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.350468209873!2d79.9205713147725!3d6.848524095050657!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25079b7550875%3A0xe031b718297dbd95!2sMinka%20Educational%20Center!5e0!3m2!1sen!2slk!4v1677591599866!5m2!1sen!2slk" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
