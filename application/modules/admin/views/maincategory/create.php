        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    Dashboard > Create Main Category
                </h5>
            </div>
        </div>
    </div>
                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/maincategory/form/<?= $obj->MainCategoryId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label for="CategoryTitle">Main Category Title</label>
                                            <input type="text" value="<?= $obj->MainCategoryTitle ?>" name="form[MainCategoryTitle]" class="form-control" id="CategoryTitle" required>
                                        </div>
                                        <!-- <div class="form-group" >
