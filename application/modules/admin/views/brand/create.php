                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Brand/form/<?= $obj->BrandId ?>">
                                <div class="row">
                                  <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="BrandTitle">Slider Title 1</label>
                                            <input type="text" value="<?= $obj->BrandTitle ?>" name="form[BrandTitle]" class="form-control" id="BrandTitle" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="BrandTitle">Slider Title 2</label>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <textarea type="text" value="<?= $obj->ShortDescription ?>" name="form[ShortDescription]" class="form-control" id="ShortDescription" required></textarea>
                                        </div> -->
                                        ...
                                        <!-- <div class="form-group">
                                            <label for="BrandTitle">Slider Button</label>
                                            ...
                                            <select name="form[btnLocation]" id="btnlocationfinder" value="<?= $obj->btnLocation ?>" class="form-control" required>
                                                ...
                                                <?php foreach ($products as $key => $row) : ?>
                                                    ...
                                                    <option value="Products-Details/<?= url_title($row->ProductTitle) ?>/<?= $row->ProductId ?>"><?= $row->ProductTitle ?></option>
