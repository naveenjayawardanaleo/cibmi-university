                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/partners/form/<?= $obj->PartnerId ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="CategoryTitle">Lecture Title</label>
                                            <input type="text" value="<?= $obj->PartnerTitle ?>" name="form[PartnerTitle]" class="form-control" id="PartnerTitle">
                                        </div>
                                    </div>
                                    <div class="col-md-6">

                                        <div class="form-group">
                                            <label for="CategoryTitle">Zoom Link</label>
                                            <input type="text" value="<?= $obj->zoomlink ?>" name="form[zoomlink]" class="form-control" id="PartnerTitle">
                                        </div>
                                    </div>
                                    <div class="col-md-6">

                                        <div class="form-group">
                                            <label for="CategoryTitle">Zoom Password</label>
                                            <input type="text" value="<?= $obj->password ?>" name="form[password]" class="form-control" id="PartnerTitle">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <!-- <div class="col-md-4" style="">
                                        <div class="form-group">
                                            <label>Default Image <small>(406px X 250px)</small></label><br>
                                            <div class="fileinput-button btn btn-primary btn-upload-primary sepH_b">
                                                <span> Upload </span>
