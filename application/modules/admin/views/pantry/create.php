                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Pantry/form/<?= $obj->PantryId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="PantryTitle">Pantry Title</label>
                                            <input type="text" value="<?= $obj->PantryTitle ?>" name="form[PantryTitle]" class="form-control" id="PantryTitle" required>
                                        </div>
                                        <div class="form-group">
