                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Hardware/form/<?= $obj->HardwareId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="HardwareTitle">Hardware Title</label>
                                            <input type="text" value="<?= $obj->HardwareTitle ?>" name="form[HardwareTitle]" class="form-control" id="HardwareTitle" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <select name="form[BrandId]" class="form-control" id="BrandId" required>
                                                <?php foreach ($brands as $row) : ?>
                                                    <option value="<?= $row->BrandId ?>" <?= $obj->BrandId == $row->BrandId ? "selected" : "" ?>><?= $row->BrandTitle ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div> -->
                                        <!-- <div class="form-group">
                                            <label for="CategoryId">Category</label>
                                            <select name="form[CategoryId]" class="form-control" id="CategoryId" required>
                                                <?php foreach ($categories as $row) : ?>
                                                    <option value="<?= $row->CategoryId ?>" <?= $obj->CategoryId == $row->CategoryId ? "selected" : "" ?>><?= $row->CategoryTitle ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div> -->
                                    </div>
