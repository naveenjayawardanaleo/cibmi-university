                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Category/form/<?= $obj->CategoryId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="PolymerTitle">Main Category</label>

                                            <!-- <input type="text" value="<?= $obj->ProductTitle ?>" name="form[ProductTitle]" class="form-control" id="ProductTitle" required> -->

                                            <select class="form-control" required name="form[MainCategoryId]" id="sel1" required>

                                                <option value="" disabled>Select Main Category</option>

                                                <?php foreach ($maincategory as $k => $row) : ?>

                                                    <option <?= ($row->MainCategoryId == $obj->MainCategoryId) ? 'selected' : '' ?> value="<?= $row->MainCategoryId ?>"><?= $row->MainCategoryTitle ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $obj->CategoryTitle ?>" name="form[CategoryTitle]" class="form-control" id="CategoryTitle" required>
                                        </div>
                                        <div class="form-group">
                                            <!-- <label for="PolymerTitle">Make a Thumbnail  in Home Page</label> -->

                                            <input type="checkbox" name="form[makeThumb]" value="No" class="form-check-input" id="" hidden checked>

                                            <div class="checkbox-list">

                                                <label class="checkbox">
                                                    <input type="checkbox" name="form[makeThumb]" value="Yes" />
                                                    <span></span>Make a Thumb in Home Page</label>
                                            </div>



                                            <!-- <select class="form-control" required name="form[makeThumb]" id="sel1" required>
                                                <option value="No">No</option>
                                                <option value="Yes">Yes</option>
                                            </select> -->
                                        </div>
                                        <h5>Fill for Home Page Thumbnail Data</h5>
                                        <hr>
                                        ...
                                        <!-- <div class="form-check">
                                            <input type="checkbox" value="form[makeThumb]" name="form[makeThumb]" class="form-check-input" id="exampleCheck1">
                                            <label class="form-check-label" for="exampleCheck1">Make a Thumb in Home Page</label>
                                        </div> -->


                                        <div class="form-group">
                                            <label>Default Image <small>(570px X 320px)</small></label><br>
