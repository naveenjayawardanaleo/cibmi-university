                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Banners/form/<?= $obj->BrandId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="BrandTitle">Text 1</label>
                                            <input type="text" value="<?= $obj->BrandTitle ?>" name="form[BrandTitle]" class="form-control" id="BrandTitle" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="BrandTitle">Text 2</label>
                                            <input type="text" value="<?= $obj->BrandTitle2 ?>" name="form[BrandTitle2]" class="form-control" id="BrandTitle2" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="BrandTitle">Text 3</label>
                                            <input type="text" value="<?= $obj->BrandPara ?>" name="form[BrandPara]" class="form-control" id="ShortDescription" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="BrandTitle">Button Name</label>
                                            <input type="text" value="<?= $obj->btnName ?>" name="form[btnName]" class="form-control" id="btnName" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="BrandTitle">Button Redirect</label>


                                            <select name="form[btnLocation]" id="btnlocationfinder" value="<?= $obj->btnLocation ?>" class="form-control" required>
                                                <option value="">Select Page</option>
                                                <option value="About-Us">About us</option>
                                                <option value="Founder-Message">Founder Message</option>
                                                ...
                                                foreach ($category as $ks => $rows) : ?>


                                                    <option value="Products/<?= url_title($rows->CategoryTitle) ?>/<?= $rows->CategoryId ?>"><?= $rows->CategoryTitle ?></option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Slider Image <small>(1760px X 780px)</small></label><br>
