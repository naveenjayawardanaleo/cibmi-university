<?php
class Hardware_document_model extends CI_Model
{
	var $_table = "hardware_document",
		$primary_key = "DocId";
	...
	public function  get_product_list($per_page = 0, $page = 0, $BrandId)
    {
        $where = 'product.BrandId = ' . $BrandId . ' AND product.IsDeleted = 0';
        $this->db->select('product.*,brand.BrandId,brand.BrandTitle');
