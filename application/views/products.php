                           ...
                           <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                              <?php foreach ($cat as $ks => $rows) : ?>
                                 ...
                                 <?php if ($row->MainCategoryId == $rows->MainCategoryId) { ?>
                                    <li><a class="dropdown-item" href="<?= base_url() ?>Products/<?= url_title($rows->CategoryTitle) ?>/<?= $rows->CategoryId ?>"><?= $rows->CategoryTitle ?>
               ...
               <nav class="px-3 flex-horizontal-center text-gray-20 d-none d-xl-flex">
                  ...
                  <p class="font-size-14 text-gray-90 mb-0">
                     ...
                     <b> <?php
                           ...
                           echo sizeof($records);
                           ?></b>
                     <?= $cate_details->CategoryTitle ?> Listed.
                  </p>
                              ...
                              <div class="product-item__inner px-xl-4 p-3">
                                 ...
                                 <div class="product-item__footer">
                                    <div class="border-top pt-2 flex-center-between flex-wrap d-flex justify-content-center">
                                       ...
                                       <p class="font-size-13 mb-0 text-gray-6 cursor-pointer-on" onclick="addtowishlist(<?= $row->ProductId ?>)">
