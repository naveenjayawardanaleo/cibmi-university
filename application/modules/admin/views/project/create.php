                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/Project/form/<?= $obj->ClientsId ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <label for="PolymerTitle">Membership</label>

                                                    <select class="form-control" required name="form[active]" id="sel1">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">First Name</label>
                                                    <input type="text" value="<?= $obj->FirstName ?>" name="form[FirstName]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Last Name</label>
                                                    <input type="text" value="<?= $obj->LastName ?>" name="form[LastName]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Email</label>
                                                    <input type="text" value="<?= $obj->Email ?>" name="form[Email]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Nic</label>
                                                    <input type="text" value="<?= $obj->Nic ?>" name="form[Nic]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">MobileNumber</label>
                                                    <input type="text" value="<?= $obj->MobileNumber ?>" name="form[MobileNumber]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">SecondNumber</label>
                                                    <input type="text" value="<?= $obj->SecondNumber ?>" name="form[SecondNumber]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Password</label>
                                                    <input type="password" value="<?= $obj->Password ?>" name="form[Password]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="ProjectTitle">Address</label>
                                                    <input type="text" value="<?= $obj->Address ?>" name="form[Address]" class="form-control" id="ProjectTitle" required>
                                                </div>
                                            </div>
                                    ...
                                    <!-- <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Default Image <small>(370px X 253px)</small></label><br>
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div>
                                            <label>More Images <small>(370px X 253px)</small></label>
                                            <div class="row ">
                                                <div class="fileinput-button btn btn-primary  btn-upload-primary sepH_b">
                                                    <span>Upload</span>
