                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/gallery/form/<?= $obj->GalleryId ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="GalleryTitle">Gallery Title</label>
                                            <input type="text" value="<?= $obj->GalleryTitle ?>" name="form[GalleryTitle]" class="form-control" id="GalleryTitle" required>
                                        </div>
                                                        ...
                                                        <li class="upload_img_single">
                                                            <div class=" thumbnail">
                                                                ...
                                                                <div class="upload_img_actions">
                                                                    ...
                                                                    <input type="hidden" name="image[]" required value="<?= $img ?>">
                                                                </div>
                                                            </div>
                                                        </li>
                                                    <?php endforeach; ?>
