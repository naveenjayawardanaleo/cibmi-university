                ...
                <div class="col-xxl-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/products/form/<?= $obj->ProductId ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="PolymerTitle">Product Title</label>

                                            <input type="text" value="<?= $obj->ProductTitle ?>" name="form[ProductTitle]" class="form-control" id="ProductTitle" required>

                                        </div>

                                        <div class="form-group">

                                            <label for="PolymerTitle">Product Category</label>

                                            <!-- <input type="text" value="< ?= $obj->ProductTitle ?>" name="form[ProductTitle]" class="form-control" id="ProductTitle" required> -->

                                            <select class="form-control" required name="form[CategoryId]" id="sel1">

                                                <option value="">Select Category</option>

                                                <?php foreach ($category as $k => $row) : ?>

                                                    <option <?= ($row->CategoryId == $obj->CategoryId) ? 'selected' : '' ?> value="<?= $row->CategoryId ?>"><?= $row->CategoryTitle ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="PolymerTitle">Colors</label> <br>

                                            <select class="js-example-basic-multiple form-control" name="form[colors]" multiple="multiple">
                                        ...
                                        <div class="form-row ">
                                            <div class="col">
                                                <label for="PolymerTitle">Price</label>

                                                <input type="text" value="<?= $obj->price ?>" name="form[price]" class="form-control" id="price">
                                            </div>
                                            <div class="col">
                                                <label for="PolymerTitle">Old Price</label>

                                                <input type="text" value="<?= $obj->oldprice ?>" name="form[oldprice]" class="form-control" id="youtube" required>
                                            </div>
                                        </div>
                                        <div class="form-row mt-5">
                                            <div class="col">
                                                <label for="PolymerTitle">SKU</label>

                                                <input type="text" value="<?= $obj->sku ?>" name="form[sku]" class="form-control" id="ProductTitle" required>
                                            </div>
                                            <div class="col">
                                                <label for="PolymerTitle">Stock</label>

                                                <input type="text" value="<?= $obj->stock ?>" name="form[stock]" class="form-control" id="ProductTitle" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row ">
                                            <div class="col">
                                                <input type="checkbox" id="featured" name="form[featured]" value="1" <?php if ($obj->featured == 1) {
                                                                                                                            echo "checked";
                                                                                                                        }

                                                                                                                        ?>>

                                                <label for="featured"> Add to Featured Products</label><br>

                                            </div>
                                            <div class="col">
                                                <input type="checkbox" id="onsale" name="form[onsale]" value="1" <?php if ($obj->onsale == 1) {
                                                                                                                        echo "checked";
                                                                                                                    }

                                                                                                                    ?>>

                                                <label for="onsale"> Add to On Sale</label><br>

                                            </div>
                                            <div class="col">
                                                <input type="checkbox" id="toprated" name="form[toprated]" value="1" <?php if ($obj->toprated == 1) {
                                                                                                                            echo "checked";
                                                                                                                        }

                                                                                                                        ?>>

                                                <label for="toprated"> Add to Top Rated</label><br>

                                            </div>
                                            <div class="col">
                                                <input type="checkbox" id="specialoffer" name="form[specialoffer]" value="1" <?php if ($obj->specialoffer == 1) {
                                                                                                                                    echo "checked";
                                                                                                                                }

                                                                                                                                ?>>

                                                <label for="specialoffer"> Add to Special Offers</label><br>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required="" class="summernote2" name="form[Specification]" id="kt_summernote_1"><?= $obj->Specification ?></textarea>
